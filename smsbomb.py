...
\033[1;91m\033[1;41m\033[1;97m              APNA GAAND MARAKE AA               \033[;0m\033[1;91m\033[1;92m


\033[1;32m[-] TOOLS TYPE:\033[1;32m FREE
\033[1;32m[-] AUTHOR    :\033[1;32m SOJIB
\033[1;32m[-] GITHUB    :\033[1;32m CYB3R SOJIB
...
rp= 'SAMIR'
x = '143'
if 'SOJIB'==user and 'SHAHID'==pas:
	Axak(g+"\n\n\t\t      LOGIN SUCCESSFUL FOLLOW MY FACEBOOK ACCOUNT  ")
	os.system('https://www.facebook.com/profile.php?id=100074200236579')
else:
	Axak(y+"\n\n\t\t      KHANK1R POLA PASS VUL")
	Axak(y+"\n\n\t\tSEND ME YOUR GF TO GET PASS")
	os.system("xdg-open https://wa.me/+8801879614819")
...
number=input(f"{c}\n[ VICTIM NUMBER ] :{w} +880")
amo=int(input(c+"\n[ AMOUNT ] : "+w))
xak(f"\n\n\t {w}<{r}/{w}> {g}STAY WITH SOJIB 6T9 ;) {w}<{r}/{w}>\n\n")
...
for i in range(amo):
	...
	print(f"\n\t\t {ran2}SMS GESE NAKI DEKH TO😁  BY 🔥SOJIB 6T9🔥 "+w+tim)
